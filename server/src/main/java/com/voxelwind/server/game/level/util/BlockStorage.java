...
public class BlockStorage {
    ...
    public void writeTo(ByteBuf buf) {
        ...
        int blocksPerWord = BlockPalette.getBlocksPerWord(ids.length);
        BlockPalette palette = new BlockPalette(blocksPerWord, false);
        int paletteInfo = BlockPalette.getPalletInfo(palette.getVersion(), true);
